...
<div class="container">
    ...
    <form method="GET" action="{{ route('admin.pqrs') }}" class="row g-3 mb-4">
        ...
        <div class="col-md-3 d-flex align-items-end">
            <a href="{{ route('admin.pqrs') }}" class="btn btn-secondary w-100">Limpiar</a>
        </div>
    </form>
    @if($pqrs->isEmpty())
    ...
    <table class="table table-bordered table-striped mt-4">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('pqrs.admin.show', ['pqr' => $pqr->id]) }}" class="btn btn-sm btn-primary">
                        Responder
                    </a>
                </td>
            </tr>
