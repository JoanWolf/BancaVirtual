                        ...
                        <td>
                            <form action="{{ route('users.destroy', $user->id) }}" method="POST">
                                <div class="action-buttons">
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn-delete" onclick="event.preventDefault(); confirm('Are you sure to delete?') ? this.closest('form').submit() : false;"><i class="fa fa-fw fa-trash"></i> {{ __('Eliminar') }}</button>
                                </div>
                            </form>
                        </td>
                    </tr>
